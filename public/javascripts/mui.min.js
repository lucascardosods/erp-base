            ...
            for (
              ...
              (i = o[l]),
                ...
                i.disabled
                  ...
                  : ((n._muiIndex = i.index),
                    (n._muiPos = b),
                    i.selected && ((C = c.children.length), (g = b), (y = b)),
                    f.push(n),
                    (b += 1)),
                E.appendChild(n);
          c.appendChild(E),
            (this.origPos = g),
            (this.currentPos = y),
            f.length && d.addClass(f[y], h);
          var x = p.getMenuPositionalCSS(t, c.children.length, C);
          return d.css(c, x), (c._scrollTop = x.scrollTop), c;
        }),
